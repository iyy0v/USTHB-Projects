...
;-----------------------------------------------
    PGCD_I proc               ;Calcule le PGCD de 2 nombre - question 1
        ...
        ; utiliser dans l'affichage de la routine
        mov val1, al
        mov val2, cl
    ...
    PGCD_I endp
;-----------------------------------------------
    PGCD_IN proc                 ;parcourir Tab et calculer le PGCD - question 3
        ;calculer le nombre d'element de Tab
        ...
        mov ah, 0
    booclePGCD_IN:
        cmp bx, dx           ;comparer l'index avec le nombre d'element du Tab
        ...
        push bx
        push dx
        call PGCD_I           ;AX = PGCD(PGCD(Elements precedents),Tab[bx])
        pop dx
        pop bx
...
;-----------------------------------------------
    afficherJourSemaine proc
        ...
        mov ax, SEG JourSemaine[bl]
                                                ; l'initialisation de donne une erreur
        call afficherS
